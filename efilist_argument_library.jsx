 ...
 * Integrated Psychological Mechanism Web (D3.js force-directed graph).
...
const OBJECTIONS = [
  ...
  },
  {
    ...
    "sources": [
      "Biological chauvinism / Speciesism",
      "TMT at species level",
      "Neanderthal extinction analogy",
      "AI accelerationism",
      "Inorganic successor framework"
    ]
  },
  {
...
const STYLES = `
  ...
  .efilist-root.legible .ef-header h1 { font-size: 20px; letter-spacing: 4px; }
  .efilist-root.legible .ef-header p { font-size: 14px; }
  .efilist-root.legible .ef-search { font-size: 16px; padding: 16px 20px; font-family: 'Georgia', serif; }
  .efilist-root.legible .ef-filter-btn { font-size: 12px; padding: 8px 14px; }
  .efilist-root.legible .ef-depth-label { font-size: 13px; }
  .efilist-root.legible .ef-depth-btn { font-size: 12px; padding: 8px 16px; }
  .efilist-root.legible .ef-tier-badge { font-size: 12px; padding: 3px 8px; }
  .efilist-root.legible .ef-category { font-size: 12px; }
  .efilist-root.legible .ef-trigger { font-size: 17px; line-height: 1.5; }
  .efilist-root.legible .ef-section-label { font-size: 12px; margin-bottom: 8px; }
  .efilist-root.legible .ef-keyword { font-size: 13px; padding: 4px 10px; }
  .efilist-root.legible .ef-psych { font-size: 15px; line-height: 1.7; }
  .efilist-root.legible .ef-diagnosis { font-size: 15px; line-height: 1.9; padding-left: 18px; border-left-width: 3px; }
  .efilist-root.legible .ef-response-box { font-size: 16px; line-height: 2.0; padding: 24px; }
  .efilist-root.legible .ef-sources { font-size: 13px; line-height: 1.8; }
  .efilist-root.legible .ef-copy-btn { font-size: 12px; padding: 8px 16px; margin-top: 12px; }
  .efilist-root.legible .ef-mode-btn { font-size: 12px; }
  .efilist-root.legible .ef-view-btn { font-size: 14px; padding: 12px 24px; }
  .efilist-root.legible .ef-obj-header { padding: 18px 22px; }
  .efilist-root.legible .ef-detail { padding: 28px 22px; }
  .efilist-root.legible .ef-section { margin-bottom: 22px; }
  .efilist-root.legible .map-node-mech text { font-size: 11px; }
  .efilist-root.legible .map-node-obj text { font-size: 9px; }

  /* === HIGH CONTRAST MODE === */
  .efilist-root.high-contrast { background: #f5f0e8; color: #1a1a1a; }
  .efilist-root.high-contrast .ef-header { border-bottom-color: #8b0000; }
  .efilist-root.high-contrast .ef-header h1 { color: #8b0000; }
  .efilist-root.high-contrast .ef-header p { color: #666; }
  .efilist-root.high-contrast .ef-search { background: #fff; border-color: #999; color: #111; }
  .efilist-root.high-contrast .ef-search:focus { border-color: #8b0000; }
  .efilist-root.high-contrast .ef-filter-btn { background: #e8e0d4; border-color: #bbb; color: #555; }
  .efilist-root.high-contrast .ef-filter-btn.active { background: #8b0000; border-color: #8b0000; color: #fff; }
  .efilist-root.high-contrast .ef-depth-btn { background: #e8e0d4; border-color: #bbb; color: #555; }
  .efilist-root.high-contrast .ef-depth-btn.active { background: #8b0000; border-color: #8b0000; color: #fff; }
  .efilist-root.high-contrast .ef-depth-label { color: #666; }
  .efilist-root.high-contrast .ef-obj-header { background: #ede8df; border-color: #ccc; }
  .efilist-root.high-contrast .ef-obj-header:hover { background: #e5ddd2; }
  .efilist-root.high-contrast .ef-obj-header.open { background: #e5ddd2; }
  .efilist-root.high-contrast .ef-trigger { color: #111; }
  .efilist-root.high-contrast .ef-category { color: #777; }
  .efilist-root.high-contrast .ef-expand-icon { color: #999; }
  .efilist-root.high-contrast .ef-detail { background: #f0ebe3; }
  .efilist-root.high-contrast .ef-section-label { color: #777; }
  .efilist-root.high-contrast .ef-keyword { color: #8b0000; background: #f5e8e8; border-color: #daa; }
  .efilist-root.high-contrast .ef-psych { color: #885522; }
  .efilist-root.high-contrast .ef-diagnosis { color: #333; border-left-color: #8b0000; }
  .efilist-root.high-contrast .ef-response-box { background: #fff; border-color: #ccc; color: #111; }
  .efilist-root.high-contrast .ef-sources { color: #555; }
  .efilist-root.high-contrast .ef-copy-btn { background: #f5e8e8; border-color: #daa; color: #8b0000; }
  .efilist-root.high-contrast .ef-copy-btn:hover { background: #e8d0d0; }
  .efilist-root.high-contrast .ef-mode-btn { background: #e8e0d4; border-color: #bbb; color: #555; }
  .efilist-root.high-contrast .ef-mode-btn.active { background: #334; border-color: #668; color: #fff; }
  .efilist-root.high-contrast .ef-view-btn { background: #f5f0e8; border-color: #bbb; color: #777; }
  .efilist-root.high-contrast .ef-view-btn.active { color: #8b0000; border-bottom-color: #8b0000; background: #fff; }
  .efilist-root.high-contrast .ef-footer { border-top-color: #ccc; color: #999; }
  .efilist-root.high-contrast .ef-empty { color: #999; }
  .efilist-root.high-contrast .ef-conf-note { background: #ede8df; border-color: #cca; color: #665; }
  ...
  /* === MAP HIGH CONTRAST === */
  .efilist-root.high-contrast .ef-map-container { background: #eee8dd; border-color: #ccc; }
  .efilist-root.high-contrast .map-link { stroke: #999; stroke-opacity: 0.2; }
  .efilist-root.high-contrast .map-link.highlighted { stroke: #8b0000; stroke-opacity: 0.7; }
  .efilist-root.high-contrast .map-node-mech text { fill: #333; }
  .efilist-root.high-contrast .map-node-obj text { fill: #888; }
  .efilist-root.high-contrast .map-node-obj.highlighted text { fill: #111; }
  .efilist-root.high-contrast .ef-map-info {
    background: linear-gradient(180deg, transparent 0%, rgba(245,240,232,0.95) 30%, #f5f0e8 100%);
  }
  .efilist-root.high-contrast .ef-map-info .mp-conns { color: #333; }
  .efilist-root.high-contrast .ef-map-legend { background: rgba(245,240,232,0.92); border-color: #ccc; }
  .efilist-root.high-contrast .ef-map-legend h3 { color: #333; border-bottom-color: #ccc; }
  .efilist-root.high-contrast .ml-item { color: #555; }
  .efilist-root.high-contrast .ef-map-toolbar button { background: #e8e0d4; border-color: #bbb; color: #555; }
  .efilist-root.high-contrast .ef-map-ctrl button { background: #e8e0d4; border-color: #bbb; color: #555; }
  .efilist-root.high-contrast .ef-goto-library { background: #f5e8e8; border-color: #daa; }
