...
STRAND_VALUES = {"bodily-sovereignty", "fetal-status"}
...
def run_live_test():
    ...
    try:
        corpus = json.load(open(os.path.join(HERE, "abortion_corpus_v0_1.json"), encoding="utf-8"))
    except Exception as e:
        return {"_overall_pass": False, "error": "cannot load seed corpus: %r" % e}
    ledger = {}
    lp = os.path.join(HERE, "abortion_grading_ledger.json")
