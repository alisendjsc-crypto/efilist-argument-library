...
Usage:
  python3 build_right_to_die_index.py [WING_DIR=../site/right-to-die] [--out right-to-die-objections-index.json]
...
SITE = os.path.normpath(os.path.join(HERE, "..", "site", "right-to-die"))
