#!/usr/bin/env python3
"""Render honest_residuals_register_v0_2.json as its readable companion.
...
SRC = os.path.join(SRC_DIR, "honest_residuals_register_v0_2.json")
OUT = os.path.join(OUT_DIR, "adversarial_map_staging", "honest_residuals_register_v0_2.md")
