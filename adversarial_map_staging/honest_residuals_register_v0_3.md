...
**Status: WORKING, and derived from a terminal artifact.** 39 honest-residue (d) entries consolidated from `adversarial_map_v1_2.json` (e4bef3ca), which is the successor assembly.
Contributing phases: A (6), B1 (5), B2 (12), C (3), D (4), E (2), F (7). Contributing nothing: R, G.
...
7 candidates derived from the two signals, 14 relations declared, 7 declared beyond what the signals detect.
