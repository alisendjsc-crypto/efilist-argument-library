...
**Rebuttal Strength Index (RSI):** Every response carries an RSI grade (A through D) reflecting the structural quality of the argument. Click the RSI badge to expand a five-axis breakdown: Validity, Soundness, Completeness, Resilience, and Autonomy. The composite score is the geometric mean of all five axes. Click "RSI METHODOLOGY" in the depth controls bar for the full formal specification. Grades adjust by response depth — PUNCH responses inherently score lower on Completeness and Resilience than DISMANTLE responses due to space constraints.
