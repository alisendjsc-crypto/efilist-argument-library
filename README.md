...
| `efilist_argument_library_v34_offline.html` | Fully self-contained offline version — D3.js embedded (~788KB) |
| `efilist_argument_library.json` | Raw data — all 74 entries with full metadata, dependency graph data, premise matrix |
| `efilist_argument_library.jsx` | React component — Library + Mechanism Web at full parity, Dependency Graph data included (rendering component partial) |
| `README.md` | This file |
| `screenshots/` | Preview images |

## Screenshots

### Library View — Standard Mode
![Library in Standard dark mode — entry expanded with Punch response visible](screenshots/library_standard.png)

### Library View — Legibility + High Contrast
![Library in Legibility + High Contrast combined mode](screenshots/library_legibility_hc.png)

### Mechanism Web (Map 2) — Mechanism Selected
![Mechanism Web with TMT node selected, connected objections highlighted](screenshots/map_mechanism.png)

### Mechanism Web (Map 2) — Objection Selected
...
![Dependency Graph with objection selected, showing premise dependencies and cross-links](screenshots/dep_graph.png)
